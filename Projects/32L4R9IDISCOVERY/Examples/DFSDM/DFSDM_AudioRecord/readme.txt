...
interlaced to use the same data wire connected to PB12. When CLK = 0, the left channel is sent
on PB12 and when CLK = 1, the right channel is sent on PB12.
...
@par Hardware and Software environment
  ...
  - STM32L4R9I-Discovery Set-up :
    - Make sure that SB1, SB29 and SB30 are in default close state.
