/**
  ******************************************************************************
  * @file    DCMI/DCMI_CaptureMode/stm32l4r9i_discovery_camera.c
...
uint8_t BSP_CAMERA_Init(uint32_t Resolution)
{
  ...
  if(ov9655_ReadID(CAMERA_I2C_ADDRESS) == OV9655_ID)
  {
    ...
    ////////////////////////////////////////////////////////////////////////////
    HAL_DCMI_ConfigCROP(phdcmi,
                          (640 - 390) / 2 - 1, /* Crop in the middle of the VGA picture */
                          (480 - 390) / 2 - 1, /* Same height (same number of lines: no need to crop vertically) */
                          (390 * 2) - 1,       /* 2 pixels clock needed to capture one pixel */
                          (390 * 1) - 1);      /* All 390 lines are captured */
    HAL_DCMI_EnableCROP(phdcmi);
    ////////////////////////////////////////////////////////////////////////////
...
__weak void BSP_CAMERA_MspInit(DCMI_HandleTypeDef *hdcmi, void *Params)
{
  ...
  hdma_handler.Instance                 = BSP_CAMERA_DMA_INSTANCE;              //DMA2_Channel6
  ...
  HAL_NVIC_SetPriority(DMA2_Channel6_IRQn, 4, 0);
