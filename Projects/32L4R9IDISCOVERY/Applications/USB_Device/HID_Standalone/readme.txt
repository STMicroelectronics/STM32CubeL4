...
enumerated as a HID device using the native PC Host HID driver to which the STM32L4R9I-Discovery
board is connected. The joystick select button is used to emulate the Mouse directions. 
When pressing the joystick select button the cursor is moving 
