...
This is a typical application on how to use the STM32L4R9I USB OTG Device peripheral to implement the DFU
capability for programming the embedded flash memory of the STM32L4R9I devices.
...
In this application, two operating modes are available:
 1. DFU operating mode: 
    This mode is entered after an MCU reset in case:
     - The DFU mode is forced by the user: the user presses the Wakeup button.
...
@note After each device reset, hold down the joystick select button on the discovery board to enter the DFU mode.     
...
@par Hardware and Software environment
  ...
  - This example runs on STM32L4R9I devices.
  ...
  - STM32L4R9I-Discovery Set-up
    - Connect the STM32L4R9I-Discovery board to the PC through 'USB micro A-Male 
      to A-Male' cable to the connector CN9 (OTG-FS) 
...
In order to make the program work, you must do the following :
 ...
 - To run the application, proceed as follows:
   ...
   - Open "DfuSe Demo" and download the "STM32L4R9I_Discovery_SysTick_0x0800C000.dfu" provided in Binary
     directory.
