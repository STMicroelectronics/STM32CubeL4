...
/* Private defines -----------------------------------------------------------*/
#define DIMMING_TaskPRIORITY        osPriorityIdle /* osPriorityIdle osPriorityBelowNormal osPriorityNormal */
...
static void DIMMING_Task( const void* argument )
{
  ...
  unsigned int  timeout_value   = osWaitForever;
