                  ...
                  if(AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].min > 55)
                  {
                    ...
                    if(AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].hour > 12)
                    {
                      ...
                      sprintf((char *)AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].alarmItems, "%s:%s %s",
                        _apHours12[AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].hour], _apMinutes[(AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].min % 60)], "AM");
                    }
                    else
                    {
                      if(AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].hour == 12)
                      {
                        sprintf((char *)AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].alarmItems, "%s:%s %s", 
                        _apHours12[AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].hour-1], _apMinutes[(AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].min % 60)], "PM");
                      }
                    }
                  }
                  else
                ...
                else
                {
                  if(AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].min > 55)
                  {
                    ...
                    if(AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].hour > 12)
                    {
                      AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].hour %= 12;
                      sprintf((char *)AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].alarmItems, "%s:%s %s", 
                        _apHours12[AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].hour], _apMinutes[(AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].min % 60)], "PM");
                    }
                    else
                    {
                      if(AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].hour == 12)
                      {
                        sprintf((char *)AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].alarmItems, "%s:%s %s", 
                        _apHours12[(AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].hour -1)], _apMinutes[(AlarmTable[AlarmOnRTC.IndexAlarmOnRTC].min %60)], "AM");
                      }
                    }
                  }
                  else
