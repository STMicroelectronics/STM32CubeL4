...
*/ 
/* Demonstration ID */
#define STEW_CODE_REVISION    0xC6010000 /* 0xAAXXYYZZ - 0xCx : Demo Code ID | 0xXXYYZZ : MajorMinorPatch Version number */
#define STEW_DATA_REVISION    0xD6010000 /* 0xAAXXYYZZ - 0xDx : Demo Data ID | 0xXXYYZZ : MajorMinorPatch Version number */
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
{
  ...
  {
    case MFX_INT_PIN:
      k_MfxWakeUp(); //For SD card and TS detection
      break;
