...
This project is targeted to run on STM32L4R5ZI device on NUCLEO-L4R5ZI-P board from STMicroelectronics. 

The reference template project configures the maximum system clock frequency at 120Mhz.

One workspace is provided for NUCLEO-L4R5ZI-P board.
...
@par Hardware and Software environment  
  ...
  - This template has been tested with NUCLEO-L4R5ZI-P board and can be
