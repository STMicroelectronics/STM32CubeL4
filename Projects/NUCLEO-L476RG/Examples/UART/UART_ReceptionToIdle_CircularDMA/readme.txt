...
Board: NUCLEO-L476RG (embeds a STM32L476RGT6 device)
...
@par Directory contents
  ...
  - UART/UART_ReceptionToIdle_CircularDMA/Inc/stm32l4xx_hal_conf.h    HAL configuration file
  - UART/UART_ReceptionToIdle_CircularDMA/Inc/stm32l4xx_it.h          DMA interrupt handlers header file
  - UART/UART_ReceptionToIdle_CircularDMA/Inc/main.h                  Header for main.c module
  - UART/UART_ReceptionToIdle_CircularDMA/Src/stm32l4xx_it.c          DMA interrupt handlers
  - UART/UART_ReceptionToIdle_CircularDMA/Src/main.c                  Main program
  - UART/UART_ReceptionToIdle_CircularDMA/Src/stm32l4xx_hal_msp.c     HAL MSP module
  - UART/UART_ReceptionToIdle_CircularDMA/Src/system_stm32l4xx.c      STM32L4xx system source file


@par Hardware and Software environment

  - This example runs on STM32L476RGTx devices.
  - This example has been tested with one NUCLEO-L476RG board embedding
    a STM32L476RGTx device and can be easily tailored to any other supported device
    and development board.

  - NUCLEO-L476RG Set-up
