/**
  ******************************************************************************
  * @file    HAL/HAL_RegisterCallbacks_TIM/Src/main.c
  ...
  *          and to call a registered callback function.
  ******************************************************************************
  * @attention
  *
...
/** @addtogroup HAL_RegisterCallbacks_TIM
  * @{
  */
...
void MyTIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim);
...
int main(void)
{
  ...
  */
  ...
  if (HAL_TIM_RegisterCallback(&TimHandle,
                               HAL_TIM_PERIOD_ELAPSED_CB_ID,
                               (pTIM_CallbackTypeDef)MyTIM_PeriodElapsedCallback) != HAL_OK)
  {
    /* Starting Error */
    Error_Handler();
  }
