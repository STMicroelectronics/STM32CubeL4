...
NUCLEO-L476RG Rev C board's LEDs can be used to monitor the transfer status :
...
NUCLEO-L476RG Rev C board's LEDs can be used to monitor the transfer status in both side:
Slave board side :
 - LED2 is turned ON when the reception process is completed.
