...
The STM32L4xx TIM1 peripheral allows programming in advance the configuration 
...
This example is based on the STM32L4xx TIM HAL and LL API. The LL API is used for performance improvement.
