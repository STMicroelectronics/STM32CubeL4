...
@par Directory contents
  ...
  - USB_Host/MSC_Standalone/Inc/usbh_diskio.h           USB diskio interface header file
...
@par Hardware and Software environment
  ...
  - B-L475E-IOT01A Set-up
    - Plug the USB Key (USB Flash Disk) into the B-L475E-IOT01A board through 'USB micro A-Male
