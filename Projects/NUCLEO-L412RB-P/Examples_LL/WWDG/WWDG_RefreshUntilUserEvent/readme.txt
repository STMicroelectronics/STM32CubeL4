...
Refresh the WWDG downcounter in the main loop - LED4 is blinking fastly & continuously

Example Execution:
When User push-button is pressed, the Downcounter automatic refresh mechanism is disabled and thus, reset occurs.
After a reset when re-entering the main function, RCC WWDG Reset Flag is checked and if we are back from a WWDG reset the LED4 is switched ON.
