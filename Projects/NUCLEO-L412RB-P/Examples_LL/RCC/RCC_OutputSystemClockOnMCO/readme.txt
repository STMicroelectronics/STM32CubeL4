...
The signal on PA8 (or pin 19 of CN6 connector) can be monitored with an oscilloscope
to check the different MCO configuration set at each User push-button press.
Different configurations will be observed
...
@par Hardware and Software environment
  ...
  - NUCLEO-L412RB-P Rev C Set-up
    - Connect the MCO pin to an oscilloscope to monitor the different waveforms:
      - PA.08: connected to pin 19 of CN6 connector for Nucleo-64 extSMPS (MB1319)
