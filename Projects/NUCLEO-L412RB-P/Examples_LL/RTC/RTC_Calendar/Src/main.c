...
int main(void)
{
  ...
  /* Check if calendar has already been set initialized */
  if(LL_RTC_IsActiveFlag_INITS(RTC) == 0x0U)
  {
    /* Configure the RTC peripheral  */
    Configure_RTC();
  ...
  /* Turn-on LED4 to indicate that calendar has been well configured */
  LED_On();
