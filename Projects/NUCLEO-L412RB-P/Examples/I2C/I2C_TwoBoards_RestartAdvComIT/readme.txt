...
SCL Pin: PC0 (CN5, pin 38)
SDA Pin: PC1 (CN5, pin 36)
...
NUCLEO-L412RB-P Rev C board's LEDs can be used to monitor the transfer status :
...
NUCLEO-L412RB-P Rev C board's LEDs can be used to monitor the transfer status in both side:
Slave board side :
 - LED4 is turned ON when the reception process is completed.
...
@par Hardware and Software environment
  ...
  - NUCLEO-L412RB-P Rev C Set-up
    - Connect I2C_SCL line of Master board (PC0, CN5, pin 38) to I2C_SCL line of Slave Board (PC0, CN5, pin 38).
    - Connect I2C_SDA line of Master board (PC1, CN5, pin 36) to I2C_SDA line of Slave Board (PC1, CN5, pin 36).
