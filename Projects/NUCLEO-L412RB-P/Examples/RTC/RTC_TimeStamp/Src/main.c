...
void HAL_RTCEx_TimeStampEventCallback(RTC_HandleTypeDef *hrtc)
{
  ...
  sprintf((char*)aShowTimeStamp,"%02hhu:%02hhu:%02hhu", sTimeStampget.Hours, sTimeStampget.Minutes, sTimeStampget.Seconds);
  /* Display date Format : mm-dd */
  sprintf((char*)aShowDateStamp,"%02hhu-%02hhu-%02hhu", sTimeStampDateget.Month, sTimeStampDateget.Date, 2016);
}
...
static void RTC_CalendarShow(void)
{
  ...
  /* Display time Format : hh:mm:ss */
  sprintf((char*)aShowTime,"%02hhu:%02hhu:%02hhu", stimestructureget.Hours, stimestructureget.Minutes, stimestructureget.Seconds);
  /* Display date Format : mm-dd-yy */
  sprintf((char*)aShowDate,"%02hhu-%02hhu-%02hhu", sdatestructureget.Month, sdatestructureget.Date, 2000 + sdatestructureget.Year);
}
