...
The ADC is configured to continuously convert ADC_CHANNEL_9, resolution is set to 12 bits right aligned, conversion is software-triggered.
...
according to the voltage applied to pin PA.04 (Morpho connector CN6 pin 30).

STM32 board LED can be used to monitor the conversion:
  - LED4 is ON when there is an error in initialization.
...
@par Hardware and Software environment
  ...
  - NUCLEO-L412RB-P Rev C Set-up
    Use an external power supply, adjust supply voltage and connect it to pin PA.04 (Morpho connector CN6 pin 30).
