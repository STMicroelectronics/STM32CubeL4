...
This example demonstrates how to use the NUCLEO-L412RB-P board to blink an LED at different speeds when the user button is pressed.
...
@note The GPIO_Demo example provides the source code for the demonstration binary package, which can be downloaded
      from the NUCLEO-L412RB-P webpage. For more details, please see the Binary Resources section here:
      https://www.st.com/en/evaluation-tools/nucleo-l412rb-p.html#tools-software
...
@par Hardware and Software environment
  ...
  - This example has been tested with NUCLEO-L412RB-P board and can be
