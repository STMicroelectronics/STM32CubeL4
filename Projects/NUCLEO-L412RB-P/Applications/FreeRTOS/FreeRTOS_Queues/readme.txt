...
NUCLEO-L412RB-P Rev C's LEDs can be used to monitor the application status:
  - LED4 should toggle as soon as the producer posts a
    message on the queue (every 1 second).
  - LED4 should be continuously ON as soon as an error occurs.
