...
This is a typical application on how to use the STM32L412xx USB FS Device peripheral to implement the DFU
capability for programming the embedded flash memory of the STM32L412xx devices.
...
@par Hardware and Software environment
  ...
  - Since there is no USB 2.0 Full speed connector (Type B) on the nucleo board, user has to make
    ...
    connectors of the STM32L412RE-Nucleo. The USB connector has to be connected to the USB device associated GPIOs
    as follows:
...
In order to make the program work, you must do the following :
 ...
 - To run the application, proceed as follows:
   ...
   - Open "DfuSe Demo" and download the "STM32L412RE_Nucleo_SysTick_0x0800C000.dfu" provided in Binary directory.
