...
This binary is a simple standalone HID. In this binary the cursor is moving forward and backward in an infinite loop.
...
@par Hardware and Software environment
  ...
  - This application has been tested with STMicroelectronics STM32L412RB-Nucleo boards and can be easily 
