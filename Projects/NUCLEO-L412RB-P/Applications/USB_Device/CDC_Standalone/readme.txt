...
This is a typical application on how to use the STM32L412xx USB Device peripheral where the STM32 MCU
...
To run this application, the user can use the following configuration:
   ...
   Connect USB cable to Host and connect UART TX pin to UART RX pin on the NUCLEO-L412RB-P board
...
@par Hardware and Software environment
  ...
  - This example has been tested with STMicroelectronics NUCLEO-L412RB-P
    board and can be easily tailored to any other supported device and development board.

  - NUCLEO-L412RB-P Set-up
