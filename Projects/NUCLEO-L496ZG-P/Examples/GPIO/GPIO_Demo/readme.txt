...
This example demonstrates how to use the NUCLEO-L496ZG-P board to blink an LED at different speeds when the user button is pressed.
The LED blinks at three different speeds, and each press of the user button changes the blinking speed

On NUCLEO-L496ZG-P (144 pins):
...
@note The GPIO_Demo example provides the source code for the demonstration binary package, which can be downloaded
      from the NUCLEO-L496ZG-P webpage. For more details, please see the Binary Resources section here:
      https://www.st.com/en/evaluation-tools/nucleo-l496zg-p.html#tools-software
...
@par Hardware and Software environment
  ...
  - This example has been tested with NUCLEO-L496ZG-P MB1312 (144 pins) board and can be
