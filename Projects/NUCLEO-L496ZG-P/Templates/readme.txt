...
This project is targeted to run on STM32L496ZG device on NUCLEO-L496ZG-P board from STMicroelectronics. 

One workspace is provided for NUCLEO-L496ZG-P board.
...
@par Hardware and Software environment  
  ...
  - This template has been tested with NUCLEO-L496ZG-P board and can be
