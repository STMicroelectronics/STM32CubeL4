...
This project is targeted to run on STM32L452RE device on NUCLEO-L452RE-P board from STMicroelectronics. 

One workspace is provided for NUCLEO-L452RE-P board.
...
@par Hardware and Software environment  
  ...
  - This template has been tested with NUCLEO-STM32L452RE-P board and can be
