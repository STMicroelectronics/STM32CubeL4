...
at each trigger event from a timer. Converted data are indefinitely transferred 
...
NUCLEO-L496ZG (144 pins)'s LED can be used to monitor ADC conversion status:
