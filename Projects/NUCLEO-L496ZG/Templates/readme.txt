...
This project is targeted to run on STM32L496ZG device on NUCLEO-L496ZG board from STMicroelectronics. 

One workspace is provided for NUCLEO-L496ZG board.
...
@par Hardware and Software environment  
  ...
  - This template has been tested with NUCLEO-L496ZG board and can be
