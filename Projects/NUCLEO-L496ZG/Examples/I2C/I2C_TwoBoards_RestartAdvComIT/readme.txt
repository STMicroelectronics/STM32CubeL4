...
NUCLEO-L496ZG (144 pins) board's LEDs can be used to monitor the transfer status :
...
NUCLEO-L496ZG (144 pins) board's LEDs can be used to monitor the transfer status in both side:
Slave board side :
 - LED1 is turned ON when the reception process is completed.
