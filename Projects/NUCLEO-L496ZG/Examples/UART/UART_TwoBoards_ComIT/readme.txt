...
NUCLEO-L496ZG (144 pins) board LEDs are used to monitor the transfer status:
...
@par Hardware and Software environment 
  ...
  - This example has been tested with two NUCLEO-L496ZG (144 pins) boards embedding
