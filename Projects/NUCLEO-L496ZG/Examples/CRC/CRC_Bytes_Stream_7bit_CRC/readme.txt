...
calculator is re-initialized with the peripheral default value that is 0x7F for a 7-bit CRC.
...
NUCLEO-L496ZG (144 pins) board's LEDs are used to monitor the example status:
