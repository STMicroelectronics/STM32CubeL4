...
This example demonstrates how to use the NUCLEO-L496ZG board to blink three LEDs at different speeds when the user button is pressed.
The LEDs blink at different speeds, and each press of the user button changes the blinking speed.

On NUCLEO-L496ZG (144 pins):
...
@note The GPIO_Demo example provides the source code for the demonstration binary package, which can be downloaded
      from the NUCLEO-L496ZG webpage. For more details, please see the Binary Resources section here:
      https://www.st.com/en/evaluation-tools/nucleo-l496zg.html#tools-software
