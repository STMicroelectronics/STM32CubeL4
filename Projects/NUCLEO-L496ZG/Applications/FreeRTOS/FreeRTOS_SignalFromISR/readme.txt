...
This application creates a thread that calls osSignalWait to wait for a signal to set bit1 and bit2 then toggles $LED1$.
...
@par Hardware and Software environment
  ...
  - This application runs on STM32L496ZG devices.
    
  - This application has been tested with NUCLEO-L496ZG (144 pins) board and can be
