...
void Menu_Init(void)
{
  ...
  BSP_LCD_DisplayStringAtLine(13, (uint8_t *)"Use [Joystick Left/Right]");
  BSP_LCD_DisplayStringAtLine(14, (uint8_t *)"to scroll up/down");
  BSP_LCD_DisplayStringAtLine(15, (uint8_t *)"Use [Joystick Up/Down]");
  BSP_LCD_DisplayStringAtLine(16, (uint8_t *)"to scroll HID menu");
