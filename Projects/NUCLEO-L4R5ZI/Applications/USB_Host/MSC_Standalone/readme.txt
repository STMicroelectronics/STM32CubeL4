...
This application is part of the USB Host Library package using STM32Cube firmware.
...
@par Hardware and Software environment
  ...
  - This application has been tested with STMicroelectronics  STM32L4R5ZI-NUCLEO
     boards and can be easily tailored to any other supported device. 

  - NUCLEO-L4R5ZI Set-up
    - Plug the USB Key (USB Flash Disk) into the NUCLEO-L4R5ZI board through 'USB micro A-Male 
