...
This application is part of the USB Device Library package using STM32Cube firmware.

This is a typical application on how to use the STM32L4R9ZI USB OTG Device peripheral where the STM32 MCU is
enumerated as a HID device using the native PC Host HID driver to which the STM32L4R9ZI-NUCLEO
board is connected. The User button is used to emulate the Mouse directions. 
When pressing the User button the cursor is moving 
...
internally a 48-MHz clock which is coming from MSI or Internal HSI48.
...
@par Hardware and Software environment
  ...
  - This application runs on STM32L4R5ZI devices.
    
  - This application has been tested with STMicroelectronics NUCLEO-L4R5ZI 
    evaluation boards and can be easily tailored to any other supported device 
    and development board.

  - NUCLEO-L4R5ZI Set-up
    - Connect the NUCLEO-L4R5ZI board to the PC through 'USB micro A-Male 
      to A-Male' cable to the connector CN14 (OTG-FS) 
