...
This is a typical application on how to use the STM32L4R5ZI USB OTG Device peripheral to implement the DFU
capability for programming the embedded flash memory of the STM32L4R5ZI devices.
...
@par Hardware and Software environment
  ...
  - NUCLEO-L4R5ZI Set-up
    - Connect the STM32L4R5ZI nucleo board to the PC through 'USB micro A-Male 
...
In order to make the program work, you must do the following :
 ...
 - To run the application, proceed as follows:
   ...
   - Open "DfuSe Demo" and download the "STM32L4R5ZI-Nucleo_SysTick_0x0800C000.dfu" provided in Binary
     directory.
