...
#define USBD_DFU_APP_DEFAULT_ADD               0x0800C000 /* The first 12 pages (48 KB) are reserved for DFU code */
#define USBD_DFU_APP_END_ADD                   0x081FF000 /*ADDR_FLASH_PAGE_511*/
