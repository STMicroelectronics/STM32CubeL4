...
Board: NUCLEO-L4R5ZI (144 pins) (embeds a STM32L4R5ZIT6 device)
SCL Pin: PC0 (CN11 (pin38) or CN9 (pin3))
SDA Pin: PC1 (CN11 (pin36) or CN9 (pin7))
...
NUCLEO-L4R5ZI (144 pins) board's LEDs can be used to monitor the transfer status :
...
NUCLEO-L4R5ZI (144 pins) board's LEDs can be used to monitor the transfer status in both side:
Slave board side :
 - LED1 is turned ON when the reception process is completed.
...
@par Hardware and Software environment
  ...
  - NUCLEO-L4R5ZI (144 pins) Set-up
    - Connect I2C_SCL line of Master board (PC0 on CN11 (pin38) or CN9 (pin3)) to I2C_SCL line of Slave Board (PC0 on CN11 (pin38) or CN9 (pin3)).
    - Connect I2C_SDA line of Master board (PC1 on CN11 (pin36) or CN9 (pin7)) to I2C_SDA line of Slave Board (PC1 on CN11 (pin36) or CN9 (pin7)).
