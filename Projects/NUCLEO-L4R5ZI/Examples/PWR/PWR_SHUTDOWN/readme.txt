...
such a case, LED1 is kept on for about 4 sec. before toggling again.

LED1 is used to monitor the system state as follows:
 - LED1 toggling: system in Run mode
 - LED1 is on for about 4 sec.: system is restarting and out-of-shutdown has been detected
