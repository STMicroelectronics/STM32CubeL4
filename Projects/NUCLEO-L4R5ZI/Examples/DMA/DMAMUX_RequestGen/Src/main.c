...
int main(void)
{
  ...
  /* -1- Initialize LEDs mounted on STM32L4R5ZI-Nucleo (144 pins) board */
  BSP_LED_Init(LED1);
  BSP_LED_Init(LED3);
  ...
  dmamux_ReqGenParams.SignalID  = HAL_DMAMUX1_REQ_GEN_EXTI13;    /* External request signal is EXTI0 signal */
