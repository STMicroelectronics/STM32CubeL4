...
STM32L4R5ZI-Nucleo (144 pins) board's LEDs can be used to monitor the transfer status:
...
@par Hardware and Software environment
  ...
  - This example runs on STM32L4R5xx device.

  - This example has been tested with STM32L4R5ZI-Nucleo (144 pins) board and can be
    easily tailored to any other supported device and development board.

  - STM32L4R5ZI-Nucleo (144 pins) Set-up
    Example is delivered for using Virtual Com port feature of STLINK for connection between STM32L4R5ZI-Nucleo (144 pins) and PC,
