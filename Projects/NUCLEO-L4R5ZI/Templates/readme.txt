...
This project is targeted to run on STM32L4R5ZI device on NUCLEO-L4R5ZI board from STMicroelectronics. 

The reference template project configures the maximum system clock frequency at 120Mhz.

One workspace is provided for NUCLEO-L4R5ZI board.
...
@par Hardware and Software environment  
  ...
  - This template runs on STM32L4R5xx devices
    
  - This template has been tested with NUCLEO-L4R5ZI (MB1312) board and can be
