...
How to use of the MSI clock source hardware autocalibration and LSE clock (PLL mode) to obtain a precise MSI clock.
...
procedure (fast blink of the LED1):
 ...
 - LED1 is turned on to indicate end of the HW calibration procedure.
