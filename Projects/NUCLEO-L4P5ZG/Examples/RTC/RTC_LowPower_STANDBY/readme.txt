...
This event is connected to EXTI_Line18.
...
In the associated software
  ...
  - the EXTI_Line18 connected internally to the RTC Alarm event is configured
...
instance, LED1 will blink.

One of the above scenario can occur.
 - LED1 Toggle: An error occurs.
 - LED1 ON: Result is OK.
...
@par Directory contents
  ...
  - RTC/RTC_LowPower_STANDBY/Inc/stm32l4xx_hal_conf.h     HAL configuration file
