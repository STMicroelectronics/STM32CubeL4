...
int main(void)
{
  ...
  /*##-2- Set Date and Time (if not already done before) #####################*/
...
static void RTC_CalendarShow(uint8_t *showtime, uint8_t *showdate)
{
  ...
  sprintf((char *)showtime, "%02hhu:%02hhu:%02hhu", stimestructureget.Hours, stimestructureget.Minutes, stimestructureget.Seconds);
  /* Display date Format : mm-dd-yy */
  sprintf((char *)showdate, "%02hhu-%02hhu-%02hhu", sdatestructureget.Month, sdatestructureget.Date, 2000 + sdatestructureget.Year);
}
