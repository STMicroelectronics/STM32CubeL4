...
5 seconds after start-up, the system automatically enters LP Sleep mode at 100 KHz and
LED1 stops toggling.
...
@note To measure the current consumption in LP Sleep mode, remove JP5 jumper
