/**
  ******************************************************************************
  * @file    PSSI/PSSI_Transmit_DMA/Src/stm32l4xx_hal_msp.c
...
void HAL_PSSI_MspInit(PSSI_HandleTypeDef *hpssi)
{
  ...
  /* Transmission */
  hdmatx.Instance                 = DMA2_Channel1;
  hdmatx.Init.Request             = DMA_REQUEST_DCMI_PSSI;
 ...
 __HAL_LINKDMA(hpssi, hdmatx, hdmatx);
