/**
  @page PSSI_Transmit_DMA Parallel Synchronous Slave Interface Transmission Example

  @verbatim
  ******************************************************************************
  * @file    PSSI/PSSI_Transmit_DMA/readme.txt
  * @author  MCD Application Team
  * @brief   Description of PSSI transmission in DMA mode Example.
  ******************************************************************************
  * @attention
  *
...
How to configure the PSSI using the HAL API to transmit data in DMA mode.
...
@par Directory contents
  ...
  - PSSI/PSSI_Transmit_DMA/Inc/stm32l4xx_hal_conf.h    HAL configuration file
  - PSSI/PSSI_Transmit_DMA/Inc/stm32l4xx_it.h          Interrupt handlers header file
  - PSSI/PSSI_Transmit_DMA/Inc/main.h                  Header for main.c module
  - PSSI/PSSI_Transmit_DMA/Src/stm32l4xx_it.c          Interrupt handlers
  - PSSI/PSSI_Transmit_DMA/Src/main.c                  Main program
  - PSSI/PSSI_Transmit_DMA/Src/stm32l4xx_hal_msp.c     HAL MSP module
  - PSSI/PSSI_Transmit_DMA/Src/system_stm32l4xx.c      STM32L4xx system source file
...
@par Hardware and Software environment
  ...
  - Connect MCO output PA.08 (pin 23 of CN12 connector) to PA.06 (pin 23 of CN12 connector)
