...
(Morpho connector CN11 pin 32) to perform a ADC conversion at a determined voltage level.
...
Other peripherals used:
  ...
  1 GPIO for LED
  1 GPIO for analog input: PA.04 (Morpho connector CN11 pin 32)
For debug: variables to monitor with debugger watch window:
 ...
 @par Directory contents
  ...
  - ADC/ADC_Oversampling/Inc/stm32l4xx_hal_conf.h    HAL configuration file
