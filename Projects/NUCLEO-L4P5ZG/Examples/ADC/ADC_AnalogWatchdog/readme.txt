...
Board settings:
 ...
 - User has to connect a voltage source to the selected ADC channel input (Morpho connector CN11 pin 32) to run this example.
...
pin PA.04 (Morpho connector CN11 pin 32).


NUCLEO-L4P5ZG (144 pins) board LEDs are used to monitor the program execution status:
