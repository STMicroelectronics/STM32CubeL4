...
Board settings:
 - ADC rank 1 is configured to convert ADC_CHANNEL_9 (pin PA.04, Morpho connector CN11 pin 32).
...
NUCLEO-L4P5ZG (144 pins) board's LEDs are used to monitor the program execution status:
