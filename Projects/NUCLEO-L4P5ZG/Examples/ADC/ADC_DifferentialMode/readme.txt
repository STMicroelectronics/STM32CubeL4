...
Board settings:
   ...
   - channel_high input is connected to ADC_CHANNEL_9 (pin PA.04, Morpho connector CN11 pin 32)
   - channel_low input is connected to ADC_CHANNEL_10 (pin PA.05, Morpho connector CN12 pin 11)
...
STM32 board's LEDs are be used to monitor the transfer status:
 - Normal operation: LED1 is turned-on/off in function of ADC conversion result.
