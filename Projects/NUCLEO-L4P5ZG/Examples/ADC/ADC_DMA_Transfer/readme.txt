...
according to the voltage applied to pin PA.04 (Morpho connector CN11 pin 32).
...
@par Hardware and Software environment
  ...
  - NUCLEO-L4P5ZG (144 pins) Set-up
    Use an external power supply, adjust supply voltage and connect it to pin PA.04 (Morpho connector CN11 pin 32).
