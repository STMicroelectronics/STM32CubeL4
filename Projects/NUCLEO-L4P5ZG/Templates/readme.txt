...
This project is targeted to run on STM32L4P5ZG device on NUCLEO-L4P5ZG board from STMicroelectronics.

The reference template project configures the maximum system clock frequency at 120Mhz.

One workspace is provided for NUCLEO-L4P5ZG board.
...
@par Hardware and Software environment
  ...
  - This template has been tested with NUCLEO-L4P5ZG (MB1312) board and can be
