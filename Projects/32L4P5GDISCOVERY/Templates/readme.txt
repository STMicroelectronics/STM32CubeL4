...
This project is targeted to run on STM32L4P5AG device on 32L4P5GDISCOVERY board from STMicroelectronics.

The reference template project configures the maximum system clock frequency at 120Mhz.

One workspace is provided for 32L4P5GDISCOVERY board.
...
@par Hardware and Software environment
  ...
  - This template runs on STM32L4P5xx devices

  - This template has been tested with 32L4P5GDISCOVERY (MB1535) board and can be
