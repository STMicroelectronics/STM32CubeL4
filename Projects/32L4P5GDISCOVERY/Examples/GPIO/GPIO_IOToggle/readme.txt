...
PG.13 and PG.14 IO (configured in output pushpull mode) toggle in a forever loop.
On STM32L4P5G-Discovery board these IOs are respectively connected to LED1 and LED2.
