...
In order to start the timer a first trigger is needed on (PA.05)(LPTIM_ETR).
Any successive trigger event on (PA.05) will reset the counter and the timer 
...
@par Hardware and Software environment
  ...
  - Connect an external trigger (ETR) to PA.05 (pin 6 of CN15 connector). 
