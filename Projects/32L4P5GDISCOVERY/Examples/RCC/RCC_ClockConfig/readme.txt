...
MSI as clock source, the Joystick Sel push-button (connected to EXTI line 13) will be
...
Each time the Joystick Sel push-button is pressed, EXTI15_10 interrupt is generated and in the ISR
the PLL oscillator source is checked using _HAL_RCC_GET_PLL_OSCSOURCE() macro:
...
@par Hardware and Software environment
  ...
  - This example has been tested with 32L4P5GDISCOVERY
