...
int main(void)
{
  ...
  /***********************************************/
  if (HAL_HASHEx_SHA224_Accmlt(&HashHandle, aInput, 64) != HAL_OK)
  {
    Error_Handler();
  }

  if (HAL_HASHEx_SHA224_Accmlt(&HashHandle, aInput+64, 64) != HAL_OK)
  {
    Error_Handler();
  }

  if (HAL_HASHEx_SHA224_Accmlt(&HashHandle, aInput+128, 64) != HAL_OK)
  {
    Error_Handler();
  }

  if (HAL_HASHEx_SHA224_Accmlt(&HashHandle, aInput+192, 64) != HAL_OK)
  {
    Error_Handler();
  }
  ...
  /*******************************/
  if (HAL_HASHEx_SHA224_Accmlt_End(&HashHandle, aInput+256, 5, aSHA224Digest, HASHTimeout) != HAL_OK)
  {
    Error_Handler();
  }
