/**
  ******************************************************************************
  * @file    HASH/HASH_SHA1SHA256_IT_DMA_Suspension/Src/main.c
...
/**
  ...
  * @note High priority block is input buffer aInput_HighPrio1, digest is 
...
static void HigherPriorityBlock_Processing(void)
{
  ...
  if (HAL_HASHEx_SHA224_Start_IT(&HashHandle, aInput_HighPrio1, HIGH_PRIO1_INPUT_TAB_SIZE, aSHA224Digest) != HAL_OK)
  {
    Error_Handler();
  }
...
/**
  ...
  * @note High priority block is input buffer aInput_HighPrio2, digest is 
  *       saved in aMD5Digest.             
  * @param  None
  * @retval None
  */
static void HigherPriorityBlock_DMA_Processing(void)
{
  ...
  /* High priority block processing */
  if (HAL_HMAC_MD5_Start_DMA(&HashHandle, aInput_HighPrio2, HIGH_PRIO2_INPUT_TAB_SIZE) != HAL_OK)
  {
    Error_Handler();
  }
