/**
  @page OSPI_NOR_ReadWrite_DMA OSPI NOR ReadWrite DMA example

  @verbatim
  ******************************************************************************
  * @file    OSPI/OSPI_NOR_ReadWrite_DMA/readme.txt
  * @author  MCD Application Team
  * @brief   Description of the OSPI NOR ReadWrite DMA mode example.
  ******************************************************************************
  * @attention
  *
...
LED_BLUE is on as soon as a comparison error occurs
