...
every 250 ms. This example is based on the STM32L4xx LL API. The peripheral 
...
On NUCLEO-L412KB Rev C board this IO is connected to LED3.
...
@par Hardware and Software environment
  ...
  - This example has been tested with NUCLEO-L412KB Rev C board and can be
