...
/* initialize the User push-button in Interrupt mode */
  ...
  /*      (RXNE flag setting)                                                 */
  BSP_LED_On(LED1);
  if(HAL_UART_Transmit(&UartHandle, &WakeUpTrigger1, 1, 5000)!= HAL_OK)
  {
    Error_Handler();
  }
  ...
  /*      (start Bit detection)                                               */
  BSP_LED_On(LED1);  
  if(HAL_UART_Transmit(&UartHandle, &WakeUpTrigger2, 1, 5000)!= HAL_OK)
  {
    Error_Handler();
  }
  ...
  /*      (7-bit address match)                                               */
  BSP_LED_On(LED1);
  if(HAL_UART_Transmit(&UartHandle, &WakeUpTrigger3, 1, 5000)!= HAL_OK)
  {
    Error_Handler();
  }
  ...
  /*      (4-bit address match)                                               */
  BSP_LED_On(LED1);
  if(HAL_UART_Transmit(&UartHandle, &WakeUpTrigger4, 1, 5000)!= HAL_OK)
  {
    Error_Handler();
  }
