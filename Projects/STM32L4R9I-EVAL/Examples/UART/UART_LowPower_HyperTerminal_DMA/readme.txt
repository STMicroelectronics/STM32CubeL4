...
Board: STM32L4R9I-EVAL  (Connector : CN7)
Tx Pin: GPIOG_7
Rx Pin: GPIOG_8
...
For this example the transmission buffers data are predefined and the reception buffer size
is limited to 10 data by the mean of the RXBUFFERSIZE define in the main.c file.

In a first step the received data will be stored in the aRxBuffer buffer and the 
aTxStartMessage and aTxEndMessage buffers content will be displayed in the Hyperterminal interface.
In a second step the received data in the aRxBuffer buffer will be sent back to 
...
@par Directory contents 
  ...
  - UART/UART_LowPower_HyperTerminal_DMA/Inc/stm32l4xx_hal_conf.h    HAL configuration file
  - UART/UART_LowPower_HyperTerminal_DMA/Inc/stm32l4xx_it.h          DMA interrupt handlers header file
  - UART/UART_LowPower_HyperTerminal_DMA/Inc/main.h                  Header for main.c module  
  - UART/UART_LowPower_HyperTerminal_DMA/Src/stm32l4xx_it.c          DMA interrupt handlers
  - UART/UART_LowPower_HyperTerminal_DMA/Src/main.c                  Main program
  - UART/UART_LowPower_HyperTerminal_DMA/Src/stm32l4xx_hal_msp.c     HAL MSP module
  - UART/UART_LowPower_HyperTerminal_DMA/Src/system_stm32l4xx.c      STM32L4xx system source file
