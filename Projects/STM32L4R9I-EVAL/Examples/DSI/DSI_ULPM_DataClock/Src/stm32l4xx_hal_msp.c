/**
  ******************************************************************************
  * @file    DSI/DSI_ULPM_DataClock/Src/stm32l4xx_hal_msp.c
...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef *hltdc)
{
  ...
  /* Configure the PLLSAI2 clock for the LTDC */
...
void HAL_DSI_MspInit(DSI_HandleTypeDef *hdsi)
{
  ...
  /* Configure the PLLSAI2 clock for DSI Ultra Low Power mode (ULPM) */
  PeriphClkInit.PeriphClockSelection = RCC_PERIPHCLK_DSI;
  PeriphClkInit.PLLSAI2.PLLSAI2Source = RCC_PLLSOURCE_MSI;
  PeriphClkInit.PLLSAI2.PLLSAI2M = 1;
  PeriphClkInit.PLLSAI2.PLLSAI2N = 60;
  PeriphClkInit.PLLSAI2.PLLSAI2Q = RCC_PLLQ_DIV2;
  PeriphClkInit.PLLSAI2.PLLSAI2ClockOut = RCC_PLLSAI2_DSICLK;
  PeriphClkInit.DsiClockSelection = RCC_DSICLKSOURCE_PLLSAI2;
  if(HAL_RCCEx_PeriphCLKConfig(&PeriphClkInit) != HAL_OK)
  {
    while(1);
  }
