...
User can vary the ADC_CHANNEL_5 voltage using the Eval Board potentiometer (RV2) 
connected to PA.00.
...
@par Hardware and Software environment 
  ...
  - On STM32L4R9I-EVAL board, make sure to set jumper JP9 in 1-2 position (POT).
