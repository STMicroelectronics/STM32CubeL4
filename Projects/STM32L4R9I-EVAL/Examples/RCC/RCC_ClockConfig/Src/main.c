...
int main(void)
{
  ...
  /* Initialize Wakeup push-button, will be used to trigger an interrupt each time it's pressed.*/
  ...
  while (1)
  {
    /* check if Wakeup push-button has been pressed to switch clock config */
