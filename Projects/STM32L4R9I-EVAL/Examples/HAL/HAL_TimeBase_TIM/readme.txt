...
When user pushes the Wakeup push-button, the Tick increment is suspended if it is already
...
@par Hardware and Software environment
  ...
  - This example has been tested with STMicroelectronics STM32L4R9I-EVAL board and can be
