...
The program waits until Wakeup push-button is pressed to begin the auto calibration.
...
@par Hardware and Software environment
  ...
  - STM32L4R9I-EVAL Set-up
    - Use LED1 connected to PB.15 pin (pin 23 in CN6 connector).
    - Use the Wakeup push-button connected to pin PC.13 (EXTI15_10)
