...
2. When applying a high level on the time stamp pin (PC.13) by pressing the Wakeup push-button,
   a time stamp event is detected and the calendar is saved in the time stamp structures.
   Each time the user presses on the Wakeup push-button, the current time and time stamp are updated and displayed
