/**
  @page OSPI_NOR_ExecuteInPlace_DTR OSPI NOR execute in place example
  
  @verbatim
  ******************************************************************************
  * @file    OSPI/OSPI_NOR_ExecuteInPlace_DTR/readme.txt 
...
mode and the code in executed in a an infinite loop. The memory is configured in octal DTR mode.
...
@par Directory contents 
  ...
  - OSPI/OSPI_NOR_ExecuteInPlace_DTR/Src/main.c                 Main program
  - OSPI/OSPI_NOR_ExecuteInPlace_DTR/Src/system_stm32l4xx.c     STM32L4xx system clock configuration file
  - OSPI/OSPI_NOR_ExecuteInPlace_DTR/Src/stm32l4xx_it.c         Interrupt handlers 
  - OSPI/OSPI_NOR_ExecuteInPlace_DTR/Src/stm32l4xx_hal_msp.c    HAL MSP module
  - OSPI/OSPI_NOR_ExecuteInPlace_DTR/Inc/main.h                 Main program header file  
  - OSPI/OSPI_NOR_ExecuteInPlace_DTR/Inc/stm32l4xx_hal_conf.h   HAL Configuration file
  - OSPI/OSPI_NOR_ExecuteInPlace_DTR/Inc/stm32l4xx_it.h         Interrupt handlers header file
