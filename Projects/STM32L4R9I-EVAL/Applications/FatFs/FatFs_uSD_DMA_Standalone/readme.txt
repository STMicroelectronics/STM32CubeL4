/**
  @page FatFs_uSD_DMA_Standalone   FatFs with uSD card drive application using the DMA
...
FAT file system module. This example develops an application making the most of
...
Middleware, SD Card, FatFs, File system, FAT Volume, Format, Mount, Read, Write, DMA

@par Directory contents

  - FatFs/FatFs_uSD_DMA_Standalone/Inc/stm32l4xx_hal_conf.h    HAL configuration file
  - FatFs/FatFs_uSD_DMA_Standalone/Inc/stm32l4xx_it.h          Interrupt handlers header file
  - FatFs/FatFs_uSD_DMA_Standalone/Inc/main.h                  Main program header file
  - FatFs/FatFs_uSD_DMA_Standalone/Src/sd_diskio_dma.h         uSD diskio_dma header file
  - FatFs/FatFs_uSD_DMA_Standalone/Inc/ffconf.h                FAT file system module configuration file
  - FatFs/FatFs_uSD_DMA_Standalone/Src/stm32l4xx_it.c          Interrupt handlers
  - FatFs/FatFs_uSD_DMA_Standalone/Src/main.c                  Main program
  - FatFs/FatFs_uSD_DMA_Standalone/Src/sd_diskio_dma.c         FatFs uSD/DMA diskio driver
  - FatFs/FatFs_uSD_DMA_Standalone/Src/system_stm32l4xx.c      stm32l4xx system clock configuration file
...
@par Hardware and Software environment
  ...
  - STM32L4R9I-EVAL Set-up
    - Connect a uSD Card to the MSD connector (CN8).
...
@note
the uSD gets formatted, please make sure to backup any relevant data before using it.
 */
