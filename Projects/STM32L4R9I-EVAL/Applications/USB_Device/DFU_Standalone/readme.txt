...
In this application, two operating modes are available:
 1. DFU operating mode: 
    This mode is entered after an MCU reset in case:
     - The DFU mode is forced by the user: the user presses the Wakeup push-button.
...
@note After each device reset, hold down the Wakeup push-button on the evaluation board to enter the DFU mode.     
...
@par Hardware and Software environment
  ...
  - STM32L4R9I-EVAL Set-up
    - Connect the STM32L4R9I-EVAL board to the PC through 'USB micro A-Male 
      to A-Male' cable to the connector CN3 (OTG-FS) 
...
In order to make the program work, you must do the following :
 ...
 - To run the application, proceed as follows:
   ...
   - Open "DfuSe Demo" and download the "STM32L4R9I_EVAL_SysTick_0x0800C000.dfu" provided in Binary
     directory.
