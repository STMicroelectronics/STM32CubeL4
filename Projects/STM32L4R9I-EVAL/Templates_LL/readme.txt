...
This project is targeted to run on STM32L4R9AI device on STM32L4R9I-EVAL board from STMicroelectronics. 

The reference template project configures the maximum system clock frequency at 120Mhz.
...
This project LL template provides:
 ...
 - Definition of LEDs and user button (file: main.h)
   Note: User button name printed on board may differ from naming "user button" in code: "wakeup push button", ...
 - Clock configuration (file: main.c)

This project LL template does not provide:
 - Functions to initialize and control LED and wakeup push button
 - Functions to manage IRQ handler of wakeup push button
...
2. Replace source files of the LL template by the ones of the LL example, except code specific to board.
   ...
   - Replace file main.h, with updates:
     - Keep LED and wakeup push button definition of the LL template under tags
...
@par Hardware and Software environment
  ...
  - This template runs on STM32L4R9xx devices.
    
  - This template has been tested with STMicroelectronics STM32L4R9I-EVAL
