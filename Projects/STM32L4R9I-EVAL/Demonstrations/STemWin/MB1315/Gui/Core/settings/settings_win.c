...
static const GUI_WIDGET_CREATE_INFO _aDialog[] = 
{
  ...
  { TEXT_CreateIndirect, "  STM32L4R9I", ID_TEXT_BOARD_1,  30,  190, 90, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "    EVAL",  ID_TEXT_BOARD_2,  40,  205, 80, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "STM32L4R9I", ID_TEXT_CORE_1,     148, 200, 80, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, " 120MHz", ID_TEXT_CPU_1,       265, 200, 80, 20, 0, 0x0, 0 },
  /* The demonstration version */
  { TEXT_CreateIndirect, "V1.0.0 ", ID_TEXT_VERSION_1,    385, 200, 80, 20, 0, 0x0, 0 }, 
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    TEXT_SetFont(hItem, &GUI_FontLubalGraph16);
    TEXT_SetTextColor(hItem, GUI_STCOLOR_LIGHTBLUE);
    sprintf((char *)tmp , "%d MHz", (HAL_RCC_GetHCLKFreq()/1000000U));
