...
#define ID_BUTTON_BKGND         (GUI_ID_USER + 0x07)
...
{
  { WINDOW_CreateIndirect, "Benchmark", ID_FRAMEWIN_INFO, 0, 0, 480, 272, 0, 0x64, 0 },
  // { TEXT_CreateIndirect, "  00000000 Pixels/s ", ID_BENCH_CPU, 100 , 170, 300, 25, 0, 0, 0 }, 
  { BUTTON_CreateIndirect, "Start Speed Benchmark", ID_BENCH_CPU, 60 , 200 , 200, 34, 0, 0, 0 },
  { LISTBOX_CreateIndirect, "List",             ID_IMAGE_LIST,    310, 64, 140, 186, 0, 0x0, 0 }  
};
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    hItem = TEXT_CreateEx(20, 50, 100, 25, pMsg->hWin, WM_CF_SHOW,0, 0x123,"");
    ...
    hGraph = GRAPH_CreateEx(20, 80, 280, 105, pMsg->hWin, WM_CF_SHOW, 0, GUI_ID_GRAPH0);
