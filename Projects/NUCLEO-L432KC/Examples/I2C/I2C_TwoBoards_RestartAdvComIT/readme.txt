...
NUCLEO-L432KC RevC board's LEDs can be used to monitor the transfer status :
...
NUCLEO-L432KC RevC board's LEDs can be used to monitor the transfer status in both side:
Slave board side :
 - LED3 is turned ON when the reception process is completed.
