...
This project is targeted to run on STM32L432KC device on NUCLEO-L432KC board from STMicroelectronics. 

One workspace is provided for NUCLEO-L432KC board.
...
@par Hardware and Software environment  
  ...
  - This template has been tested with NUCLEO-L432KC RevC board and can be
