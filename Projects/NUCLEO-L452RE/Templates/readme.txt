...
This project is targeted to run on STM32L452RE device on NUCLEO-L452RE board from STMicroelectronics. 

One workspace is provided for NUCLEO-L452RE board.
...
@par Hardware and Software environment  
  ...
  - This template has been tested with NUCLEO-L452RE board and can be
