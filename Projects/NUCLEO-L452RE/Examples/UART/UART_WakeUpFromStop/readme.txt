/**
  ...
  * @brief   Description of the UART-triggered MCU wake-up from Stop 1 mode.
  ******************************************************************************
  * @attention
  *
...
Configuration of an UART to wake up the MCU from Stop 1 mode 
when a given stimulus is received.

Board: NUCLEO-L452RE Rev C (embeds a STM32L452RET6 device)
...
Board 1 enters Stop 1 mode and is awoken by Board 2 which sends
...
This means that board 1 has entered Stop 1 mode.
...
@par Hardware and Software environment 
  ...
  - This example has been tested with a couple of NUCLEO-L452RE Rev C boards embedding a 
